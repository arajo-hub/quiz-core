...
public enum ErrorCode {
    ...
    QUIZ_QUESTION_SESSION_MISMATCH(4003, "문제가 해당 세션에 속하지 않습니다."),
    QUIZ_QUESTION_INVALID_TYPE(4004, "잘못된 문제 유형입니다."),
    QUIZ_QUESTION_OPTIONS_INVALID(4005, "문제 보기가 잘못되었습니다."),
    QUIZ_QUESTION_ORDER_INVALID(4006, "잘못된 문제 순서입니다."),
